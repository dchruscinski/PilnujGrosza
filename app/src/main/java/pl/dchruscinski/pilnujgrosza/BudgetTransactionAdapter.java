...
public class BudgetTransactionAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public BudgetTransactionAdapter(Context context, Activity activity, ArrayList transactionsList) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        if (viewType == VIEW_TYPE_EXPENSE_VIEW) {
            ...
            vh = new BudgetTransactionAdapter.ViewHolderExpense(v);
        } else if (viewType == VIEW_TYPE_INCOME_VIEW) {
            v = inflater.inflate(R.layout.inc_rc_row, parent, false);
            vh = new BudgetTransactionAdapter.ViewHolderIncome(v);
        } else {
            v = inflater.inflate(R.layout.trans_empty_view, parent, false);
            vh = new BudgetTransactionAdapter.ViewHolderEmpty(v);
        }
        return vh;
    }
